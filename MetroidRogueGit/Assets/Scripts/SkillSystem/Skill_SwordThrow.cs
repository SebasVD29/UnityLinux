...
public class Skill_SwordThrow : Skill_Base
{
    ...
    [SerializeField] private float currentThrowPower;
    ...
    {
        if (Unlocked(SkillUnlockType.SwordThrow))
            return swordPrefab;

        if (Unlocked(SkillUnlockType.SwordThrow_Spin))
            return spinSwordPrefab;

        if (Unlocked(SkillUnlockType.SwordThrow_Bouce))
    ...
    {
        switch (skillUnlockType)
        {
            case SkillUnlockType.SwordThrow:
                currentThrowPower = regularThrowPower;
                break;
          
            case SkillUnlockType.SwordThrow_Spin:
                currentThrowPower = spinThrowPower;
                break;
            case SkillUnlockType.SwordThrow_Bouce:
